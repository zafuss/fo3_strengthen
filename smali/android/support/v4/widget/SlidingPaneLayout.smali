...
# static fields
.field static final a:Landroid/support/v4/widget/y;
...
.field private o:Landroid/support/v4/widget/w;

.field private final p:Landroid/support/v4/widget/ac;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->a:Landroid/support/v4/widget/y;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/t;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;)V
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/widget/v;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/support/v4/widget/s;)V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/ac;

    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/ac;
...
.method private a(Landroid/view/View;FI)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v4/widget/u;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V
...
.method static synthetic b(Landroid/support/v4/widget/SlidingPaneLayout;)Landroid/support/v4/widget/ac;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/ac;
...
.method private g(Landroid/view/View;)V
    ...
    sget-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->a:Landroid/support/v4/widget/y;

    invoke-interface {v0, p0, p1}, Landroid/support/v4/widget/y;->a(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V
...
.method a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:Landroid/support/v4/widget/w;
    ...
    invoke-interface {v0, p1, v1}, Landroid/support/v4/widget/w;->a(Landroid/view/View;F)V
...
.method a(FI)Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/ac;
    ...
    invoke-virtual {v2, v3, v0, v4}, Landroid/support/v4/widget/ac;->a(Landroid/view/View;II)Z
...
.method b(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/w;->a(Landroid/view/View;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/w;->b(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ac;->f()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/u;->run()V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/ac;
    ...
    invoke-virtual {v4, v0, v5, v6}, Landroid/support/v4/widget/ac;->b(Landroid/view/View;II)Z
    ...
    :goto_2
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/ac;
    ...
    invoke-virtual {v4, v5, v0, v3}, Landroid/support/v4/widget/ac;->b(Landroid/view/View;II)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/ac;

    invoke-virtual {v5}, Landroid/support/v4/widget/ac;->d()I
    ...
    invoke-virtual {v3, v4, v1, v2}, Landroid/support/v4/widget/ac;->b(Landroid/view/View;II)Z
...
.method public setPanelSlideListener(Landroid/support/v4/widget/w;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:Landroid/support/v4/widget/w;
