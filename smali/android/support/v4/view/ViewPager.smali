...
.field private static final af:Landroid/support/v4/view/cg;
...
.field private Z:Landroid/support/v4/view/cc;

.field private aa:Landroid/support/v4/view/cb;

.field private ab:Landroid/support/v4/view/cd;
...
.field private final f:Landroid/support/v4/view/bz;
...
.field private n:Landroid/support/v4/view/ce;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->af:Landroid/support/v4/view/cg;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/bz;
...
.method private a(IFII)I
    ...
    check-cast v0, Landroid/support/v4/view/bz;
    ...
    check-cast v1, Landroid/support/v4/view/bz;

    iget v0, v0, Landroid/support/v4/view/bz;->b:I

    iget v1, v1, Landroid/support/v4/view/bz;->b:I
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bz;

    move-result-object v3

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/widget/Scroller;

    iget v3, v3, Landroid/support/v4/view/bz;->e:F
    ...
    iget v0, v0, Landroid/support/v4/view/bz;->e:F
...
.method private a(IZIZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bz;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/cc;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/cc;
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/cc;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/cc;

    invoke-interface {v2, p1}, Landroid/support/v4/view/cc;->a(I)V

    :cond_3
    if-eqz p4, :cond_4

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/cc;
...
.method private a(Landroid/support/v4/view/bz;ILandroid/support/v4/view/bz;)V
    .locals 11
    ...
    iget v0, p3, Landroid/support/v4/view/bz;->b:I

    iget v1, p1, Landroid/support/v4/view/bz;->b:I

    if-ge v0, v1, :cond_3

    iget v1, p3, Landroid/support/v4/view/bz;->e:F

    iget v2, p3, Landroid/support/v4/view/bz;->d:F
    ...
    :goto_2
    iget v5, v0, Landroid/support/v4/view/bz;->b:I
    ...
    :cond_2
    iput v3, v0, Landroid/support/v4/view/bz;->e:F

    iget v0, v0, Landroid/support/v4/view/bz;->d:F
    ...
    iget v3, p3, Landroid/support/v4/view/bz;->e:F
    ...
    :cond_5
    iget v5, v0, Landroid/support/v4/view/bz;->d:F
    ...
    iget v2, p1, Landroid/support/v4/view/bz;->e:F
    ...
    iget v0, p1, Landroid/support/v4/view/bz;->e:F
    ...
    iget v3, p1, Landroid/support/v4/view/bz;->d:F
    ...
    :goto_a
    iget v2, v0, Landroid/support/v4/view/bz;->b:I
    ...
    :cond_9
    iget v2, v0, Landroid/support/v4/view/bz;->d:F

    add-float/2addr v2, v6

    sub-float v2, v3, v2

    iput v2, v0, Landroid/support/v4/view/bz;->e:F
    ...
    iget v1, p1, Landroid/support/v4/view/bz;->d:F
...
.method private a(Z)V
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/bz;->c:Z

    if-eqz v5, :cond_2

    iput-boolean v2, v0, Landroid/support/v4/view/bz;->c:Z
...
.method private b(F)Z
    ...
    iget v8, v0, Landroid/support/v4/view/bz;->b:I
    ...
    :goto_0
    iget v8, v1, Landroid/support/v4/view/bz;->b:I
    ...
    iget v1, v1, Landroid/support/v4/view/bz;->e:F
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/h;
...
.method private d(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->i()Landroid/support/v4/view/bz;
    ...
    iget v5, v1, Landroid/support/v4/view/bz;->b:I
    ...
    iget v6, v1, Landroid/support/v4/view/bz;->e:F

    sub-float/2addr v2, v6

    iget v1, v1, Landroid/support/v4/view/bz;->d:F
...
.method private h()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->af:Landroid/support/v4/view/cg;
...
.method private i()Landroid/support/v4/view/bz;
    .locals 13
    ...
    iget v10, v0, Landroid/support/v4/view/bz;->b:I

    add-int/lit8 v11, v8, 0x1

    if-eq v10, v11, :cond_6

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/bz;

    add-float/2addr v6, v7

    add-float/2addr v6, v1

    iput v6, v0, Landroid/support/v4/view/bz;->e:F

    add-int/lit8 v6, v8, 0x1

    iput v6, v0, Landroid/support/v4/view/bz;->b:I

    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/ae;

    iget v7, v0, Landroid/support/v4/view/bz;->b:I

    invoke-virtual {v6, v7}, Landroid/support/v4/view/ae;->b(I)F

    move-result v6

    iput v6, v0, Landroid/support/v4/view/bz;->d:F
    ...
    :goto_3
    iget v6, v2, Landroid/support/v4/view/bz;->e:F

    iget v7, v2, Landroid/support/v4/view/bz;->d:F
    ...
    :cond_5
    iget v5, v2, Landroid/support/v4/view/bz;->b:I

    iget v4, v2, Landroid/support/v4/view/bz;->d:F
...
.method private setScrollState(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/cd;
...
.method a(II)Landroid/support/v4/view/bz;
    .locals 2
    ...
    iput p1, v0, Landroid/support/v4/view/bz;->b:I
    ...
    iput-object v1, v0, Landroid/support/v4/view/bz;->a:Ljava/lang/Object;
    ...
    iput v1, v0, Landroid/support/v4/view/bz;->d:F
...
.method a(Landroid/view/View;)Landroid/support/v4/view/bz;
    .locals 4
    ...
    iget-object v3, v0, Landroid/support/v4/view/bz;->a:Ljava/lang/Object;
...
.method a(Landroid/support/v4/view/cc;)Landroid/support/v4/view/cc;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/cc;

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/cc;
...
.method a()V
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/h;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/view/ca;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method a(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bz;
    ...
    check-cast v2, Landroid/support/v4/view/bz;

    iget v7, v2, Landroid/support/v4/view/bz;->b:I
    ...
    invoke-virtual {v0, v2, v5}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bz;
    ...
    :cond_5
    iget v6, v10, Landroid/support/v4/view/bz;->d:F
    ...
    invoke-direct {v0, v10, v8, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/bz;ILandroid/support/v4/view/bz;)V
    ...
    iget-object v2, v10, Landroid/support/v4/view/bz;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bz;

    move-result-object v6

    if-eqz v6, :cond_8

    iget v7, v6, Landroid/support/v4/view/bz;->d:F

    iput v7, v2, Landroid/support/v4/view/ViewPager$LayoutParams;->c:F

    iget v6, v6, Landroid/support/v4/view/bz;->b:I
    ...
    iget v7, v10, Landroid/support/v4/view/bz;->d:F
    ...
    :cond_c
    iget v15, v2, Landroid/support/v4/view/bz;->b:I

    if-ne v9, v15, :cond_d

    iget-boolean v15, v2, Landroid/support/v4/view/bz;->c:Z
    ...
    iget-object v2, v2, Landroid/support/v4/view/bz;->a:Ljava/lang/Object;
    ...
    iget v2, v2, Landroid/support/v4/view/bz;->d:F
    ...
    invoke-virtual {v0, v9, v2}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bz;
    ...
    :cond_15
    iget v11, v2, Landroid/support/v4/view/bz;->b:I

    if-ne v9, v11, :cond_20

    iget-boolean v11, v2, Landroid/support/v4/view/bz;->c:Z
    ...
    invoke-virtual {v0, v9, v7}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bz;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Landroid/support/v4/view/bz;
    ...
    iget v2, v2, Landroid/support/v4/view/bz;->b:I
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bz;

    move-result-object v5

    if-eqz v5, :cond_1e

    iget v5, v5, Landroid/support/v4/view/bz;->b:I
...
.method protected a(IFI)V
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/cd;

    invoke-interface {v5, v3, v0}, Landroid/support/v4/view/cd;->a(Landroid/view/View;F)V
...
.method a(IZZI)V
    ...
    iput-boolean v3, v0, Landroid/support/v4/view/bz;->c:Z
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bz;

    move-result-object v4

    if-eqz v4, :cond_0

    iget v4, v4, Landroid/support/v4/view/bz;->b:I
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bz;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    instance-of v3, p1, Landroid/support/v4/view/by;
...
.method b(I)Landroid/support/v4/view/bz;
    .locals 3
...
.method b(Landroid/view/View;)Landroid/support/v4/view/bz;
    .locals 2
    ...
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bz;
...
.method b()V
    ...
    iget-object v9, v0, Landroid/support/v4/view/bz;->a:Ljava/lang/Object;
    ...
    :cond_3
    iget v9, v0, Landroid/support/v4/view/bz;->b:I

    if-eq v9, v7, :cond_a

    iget v6, v0, Landroid/support/v4/view/bz;->b:I
    ...
    :cond_4
    iput v7, v0, Landroid/support/v4/view/bz;->b:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/h;

    invoke-virtual {v4, v2, v3}, Landroid/support/v4/widget/h;->a(II)V

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/h;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v4, v1, Landroid/support/v4/view/bz;->e:F
    ...
    iget v3, v1, Landroid/support/v4/view/bz;->b:I
    ...
    iget v10, v2, Landroid/support/v4/view/bz;->b:I
    ...
    iget v3, v1, Landroid/support/v4/view/bz;->e:F

    iget v4, v1, Landroid/support/v4/view/bz;->d:F
    ...
    iget v11, v1, Landroid/support/v4/view/bz;->d:F
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bz;
    ...
    iget v10, v10, Landroid/support/v4/view/bz;->e:F
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bz;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v5, v4, Landroid/support/v4/view/bz;->b:I
    ...
    iget v3, v4, Landroid/support/v4/view/bz;->e:F

    sub-float/2addr v2, v3

    iget v3, v4, Landroid/support/v4/view/bz;->d:F
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/h;
...
.method public setAdapter(Landroid/support/v4/view/ae;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/ce;
    ...
    iget v4, v0, Landroid/support/v4/view/bz;->b:I

    iget-object v0, v0, Landroid/support/v4/view/bz;->a:Ljava/lang/Object;
    ...
    new-instance v1, Landroid/support/v4/view/ce;

    invoke-direct {v1, p0, v5}, Landroid/support/v4/view/ce;-><init>(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/bv;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/ce;

    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/ae;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/ce;
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/cb;
    ...
    invoke-interface {v1, v0, p1}, Landroid/support/v4/view/cb;->a(Landroid/support/v4/view/ae;Landroid/support/v4/view/ae;)V
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/cb;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/cb;

    return-void
.end method

.method public setOnPageChangeListener(Landroid/support/v4/view/cc;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/cc;
